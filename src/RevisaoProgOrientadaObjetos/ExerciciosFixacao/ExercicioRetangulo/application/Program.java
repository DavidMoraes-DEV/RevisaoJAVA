package RevisaoProgOrientadaObjetos.ExerciciosFixacao.ExercicioRetangulo.application;

import java.util.Locale;
import java.util.Scanner;

import RevisaoProgOrientadaObjetos.ExerciciosFixacao.ExercicioRetangulo.entities.Rectangle;
