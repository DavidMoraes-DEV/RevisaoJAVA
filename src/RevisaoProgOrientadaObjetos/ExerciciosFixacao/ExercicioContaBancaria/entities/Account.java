package RevisaoProgOrientadaObjetos.ExerciciosFixacao.ExercicioContaBancaria.entities;
...
public class Account {
	...
	public Account (int numeroConta, String nomeTitular, double depositoInicial) {
		this.numeroConta = numeroConta;
		this.nomeTitular = nomeTitular;
