...
public class RevisaoComposicao {
	...
	public static void main(String[] args) throws ParseException {
		...
		Trabalhador trabalhador = new Trabalhador(nomeTrab, NivelTrabalhador.valueOf(nivelTrab), salarioTrab, new Departamento(nomeDepartamento));
		...
		for(int i=0; i<qtdContratos; i++) {
			...
			ContratoPorHoras contrato = new ContratoPorHoras(dataContrato, valorPorHora, horas);
			
			trabalhador.addContrato(contrato); //Associa o contrato com o trabalhador.
		}
		...
		System.out.printf("%n%nNome do trabalhador: %s", trabalhador.getNome());
		System.out.printf("%nDepartamento: %s", trabalhador.getDepartamento().getNome());
		System.out.printf("%nSalario para %s: ", mesEano);
		System.out.print(trabalhador.rendaMes(mes, ano));
